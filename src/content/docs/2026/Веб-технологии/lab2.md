...
1. Выберите подход к именованию классов: утилитарный (utility) или семантический (BEM, OOCSS, SMACSS, CUBE).
...
Это улучшит время загрузки шрифтов и производительность, уменьшит количество запросов, уберёт необходимость в предварительном подключении и не будет передавать данные в Google.
...
1. Держите css в чистоте и порядке, смотрите не повторяете ли вы какие-то объявления в правилах многократно.
