...
Используя функцию из прошлой задачи, реализовать функцию, которая возвращает новый массив, содержащий n случайных значений из переданного массива.

```
sampleArray(["a","b","c","d"], 2) -> ["b","c"]
sampleArray(["a","b","c"], 3) -> ["c","c","a"]
```
